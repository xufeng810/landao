<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"E:\phpstudy\WWW\project\public/../application/backend\view\article_cate\cateadd.html";i:1515129940;s:77:"E:\phpstudy\WWW\project\public/../application/backend\view\public\header.html";i:1514900796;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<article class="page-container">
	...
	<div class="row cl">
		<label class="form-label col-xs-2 col-sm-3"><span class="c-red"></span>分类名称：</label>
	...
	<div class="row cl">
			<label class="form-label col-xs-2 col-sm-3"><span class="c-red"></span>状态：</label>
	...
	<div class="row cl">
		<label class="form-label col-xs-2 col-sm-3"><span class="c-red"></span>排序</label>
		<div class="formControls col-xs-10 col-sm-9">
...
$(function(){
	...
	$("#form-admin-add").validate({
		...
		submitHandler:function(form){
			$.ajax({  
                        type: 'post',  
                        url: "<?php echo url('articleCate/cateAdd'); ?>", 
                        data:{
                        	id:$('#hidden-id').val(),
                        	pid:$('#hidden-pid').val(),
                            title:$('#title').val(),
                        ...
                        success:function(data){
                            if(data.status==1){
								...
								parent.location.href="<?php echo url('articleCate/cateList'); ?>";
