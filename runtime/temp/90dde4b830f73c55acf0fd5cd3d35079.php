<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"E:\phpstudy\WWW\project\public/../application/index\view\orde\orderalllist.html";i:1514900795;s:75:"E:\phpstudy\WWW\project\public/../application/index\view\public\header.html";i:1514900796;s:75:"E:\phpstudy\WWW\project\public/../application/index\view\public\footer.html";i:1514900796;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 工单管理 <span class="c-gray en">&gt;</span> 工单汇总 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新"  class="btn-refresh"><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container"><form action="<?php echo url('orde/orderAllList'); ?>" method="get" class="layui-form">
	<div class="text-c">
	    ...
	    <div class="layui-inline">
	      <div class="layui-input-inline" style="width:150px;">
	        <select name="uid" lay-verify="required" lay-search="" >
	          ...
	          <?php if(is_array($aulist) || $aulist instanceof \think\Collection || $aulist instanceof \think\Paginator): if( count($aulist)==0 ) : echo "" ;else: foreach($aulist as $key=>$v): if($v['id'] == $param['uid']): ?>
	          		<option value="<?php echo $v['id']; ?>" selected><?php echo $v['real_name']; ?></option>  
				<?php else: ?>
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="<?php echo url('orde/orderDown',array('type'=>'all','starttime'=>&$param['starttime'],'endtime'=>&$param['endtime'],'uid'=>&$param['uid'],'status'=>&$param['status'],'name'=>&$param['name'],'phone'=>&$param['phone'],'address'=>&$param['address'])); ?>"  class='btn btn-warning radius <?php echo ruleCheck("index/Order/orderdown");?>' ><i class="Hui-iconfont">&#xe640;</i> 批量导出</a> </span> <span class="r">共有数据：<strong><?php echo $data->totalshow(); ?></strong> 条</span> </div>
	<table class="table table-border table-bordered table-bg ">
		...
		<?php foreach($data as $vo): ?>
			<tr class="text-c text-hidden-<?php echo $vo['id']; ?>">
				...
				<td>
					<a href="javascript:;" onclick="orderstatus(<?php echo $vo['id']; ?>,<?php echo $vo['status']; ?>)">
					<?php if($vo['status']==1): ?>
				...
				<td><?php echo $vo->hasadminone->real_name; ?></td>
				<td>
...
<script type="text/javascript">
	...
	function orderstatus(id,status){
      layer.open({
          ...
          maxmin: true,
          type: 2,
          content: ["orderstatus.html?id="+id+"&status="+status,'no'],
          area: ['450px', '300px']
      });
  	}
