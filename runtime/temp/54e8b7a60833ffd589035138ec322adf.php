<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"E:\phpstudy\WWW\project\public/../application/index\view\login\index.html";i:1514965109;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
    ...
    <form class="form form-horizontal">
      ...
      <div class="row cl verify"> 
        ...
        <div class="formControls col-xs-8">
          ...
          <img class="verify-image" src="<?php echo url('index/login/captcha'); ?>" alt="验证码" title="点击换一张" onclick="this.src='<?php echo url('index/login/captcha'); ?>?num='+Math.random()" id="verify-image"> 
        </div>
      </div>
