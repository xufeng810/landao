<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"E:\phpstudy\WWW\project\public/../application/index\view\admin_users\adminlist.html";i:1514900793;s:75:"E:\phpstudy\WWW\project\public/../application/index\view\public\header.html";i:1514900796;s:75:"E:\phpstudy\WWW\project\public/../application/index\view\public\footer.html";i:1514900796;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
	...
	<table class="table table-border table-bordered table-bg">
		...
		<?php foreach($data as $vo): ?>
			<tr class="text-c text-hidden-<?php echo $vo['id']; ?>">
				...
				<td>
					<span class='td-manage-<?php echo $vo['id']; ?> <?php echo ruleCheck("index/AdminUsers/adminstatus");  ?>'>
					<?php if($vo['status']==1): ?> 
					...
					<span class=' <?php echo ruleCheck("index/AdminUsers/adminadd");  ?>'>
					...
					<?php endif; ?>
					<span class=' <?php echo ruleCheck("index/AdminUsers/admindelete");  ?>'>
