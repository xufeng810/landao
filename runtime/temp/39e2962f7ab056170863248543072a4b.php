<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"E:\phpstudy\WWW\project\public/../application/backend\view\index\index.html";i:1515461443;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
				...
				<ul class="cl">
					...
					<li class="dropDown dropDown_hover" style="margin-left:10px;"> <?php echo \think\Session::get('ausess.admin_name'); ?> <i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							...
							<li><a href="<?php echo url('ConfigManage/refresh'); ?>">清除缓存</a></li>
